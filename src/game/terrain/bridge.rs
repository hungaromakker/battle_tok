...
fn generate_planks(start: Vec3, end: Vec3, direction: Vec3, right: Vec3, config: &BridgeConfig) -> Mesh {
    let mut mesh = Mesh::new();
...
fn generate_oriented_plank(center: Vec3, size: Vec3, forward: Vec3, right: Vec3, color: [f32; 4]) -> Mesh {
...
pub fn get_bridge_height(x: f32, z: f32, start: Vec3, end: Vec3, config: &BridgeConfig) -> Option<f32> {
